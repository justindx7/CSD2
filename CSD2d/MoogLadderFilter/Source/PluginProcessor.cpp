...
parameters(*this, nullptr, "Parameters", {
    std::make_unique<AudioParameterFloat>("cutoff",
                                          "Cutoff",
                                          NormalisableRange<float>(20.0f, 20000.0f, 0.1f, 0.22),
                                          20000.0f),
    
    std::make_unique<AudioParameterFloat>("resonance",
                                          "Resonance",
                                          NormalisableRange<float>(0.0f, 1.0, 0.01f),
                                          0.0f)
})
#endif
{
    ...
    effects.push_back(LadderFilter(1,false));
    effects.push_back(LadderFilter(1,false));
...
//==============================================================================
const juce::String MoogLadderFilterAudioProcessor::getName() const
{
...
const juce::String MoogLadderFilterAudioProcessor::getProgramName (int index)
{
    return {};
}

void MoogLadderFilterAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void MoogLadderFilterAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    
    for(auto &effect : effects)
    {
        effect.setParameter("cutoff", *cutoffParameter);
        effect.setParameter("resonance", *resonanceParameter);
    }
    ...
    for (int channel = 0; channel < totalNumInputChannels; ++channel)
    {
        ...
        channelData[sample] = effects[channel].applyEffect(readPointer[sample]);
        }
    }
}
...
juce::AudioProcessorEditor* MoogLadderFilterAudioProcessor::createEditor()
{
    return new MoogLadderFilterAudioProcessorEditor (*this, parameters);
}

//==============================================================================
void MoogLadderFilterAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
